...
void telescope_step(telescope_st *this, uint16_t step_ms) {
	...
	// telescope assembly invert disabled driving module. This way D4WD is always
	// active when driving and the trailer doesnt pull even on 1st gear
	drive_set_drive_disabled(&dev.drive, this->conf->out_conf.assembly_invert);
